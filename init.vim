...
if exists('g:vscode')
  ...
  source $HOME/.config/nvim/plug-config/vim-template.vim
  ...
  source $HOME/.config/nvim/plug-config/md-image-paste.vim
...
unmap <C-I>
set runtimepath^=/Users/kk/LocalDocuments/my_project/coc-playground
"set runtimepath^=~/.config/coc/extensions/node_modules/coc-playground
" nnoremap <silent> <leader>TA <Plug>(coc-playground-keymap)
" 妈的 nnoremap 就是不行
" nmap <silent> gr <Plug>(coc-playground-keymap)
